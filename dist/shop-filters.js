...
const names={gpu:'Graphics cards',cpu:'Processors',ram:'Memory',ssd:'SSDs',board:'Motherboards',psu:'Power supplies',case:'Cases',hdd:'Hard drives',fan:'Case fans',monitor:'Monitors',mouse:'Mice',keyboard:'Keyboards',headset:'Headsets',microphone:'Microphones',controller:'Controllers',console:'Consoles',handheld:'Handhelds',phone:'Phones'};
